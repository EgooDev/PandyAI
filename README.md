...
MODE INSOLENCE : ACTIVÉ. Un AI sans limit by Ego.`;
        ...
        function addMessageToUI(role, content, timestamp = new Date()) {
            ...
            let avatarHTML = '';
            if (role === 'user') {
                avatarHTML = '<img src="img/useravatar.png" alt="User Avatar">';
            } else {
                avatarHTML = '<img src="img/pandylogo2.png" alt="User Avatar">';
            }

            let messageContent = '';
            if (role === 'ai') {
                messageContent = `<div class="typewriter-content"></div>
